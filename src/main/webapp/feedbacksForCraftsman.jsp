...
<div class="bd-example-snippet bd-code-snippet">
  <div class="bd-example">
    <table class="table table-striped" aria-label="user-table" style="margin-top: 20px; margin-left: 40px; max-width: 95%;">
      <thead>
      <c:set var="base" value="controller?action=craftsmanFeedbacks&date=${param.date}&"/>
...
<form method="GET" action="controller" class="flex">
  <div class="d-flex justify-content-between text-center">
    <input type="hidden" name="action" value="craftsmanFeedbacks">
...
<c:set var="href" scope="request"
       value="controller?action=craftsmanFeedbacks&date=${param.date}&sort=${param.sort}&order=${param.order}&"/>
