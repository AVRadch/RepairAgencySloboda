        ...
        <div class="navbar">
          <div class="navbar-inner">
            <div class="container-fluid">
              <ul class="nav">
                <li>
                  <a href="controller?action=craftsmanFeedbacks"><fmt:message key="button.feedbacks"/></a>
                </li>

                <li>
                  <a href="controller?action=craftsmanRequest"><fmt:message key="button.requests"/></a>
                </li>
