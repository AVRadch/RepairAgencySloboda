...
<div class="container">
  <div class="row main">
    ...
    <div class="main-login main-center">
      ...
      <form class="form-horizontal" method="post" action="controller?action=updateProfile">
        <input type="hidden" id="custId" name="user-id" value="${sessionScope.logged_user.id}">
          ...
          <div class="cols-sm-10">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="email" id="email"
                     ...
                     required value="${sessionScope.logged_user.email}"
                     <%--disabled --%>/>
            </div>
          </div>
        </div>
          ...
          <div class="cols-sm-10">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="firstname" id="firstname"
                     ...
                     value="${sessionScope.logged_user.firstName}"/>
            </div>
          </div>
        </div>
          ...
          <div class="cols-sm-10">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="lastname" id="lastname"
                     ...
                     required value="${sessionScope.logged_user.lastName}"/>
            </div>
          </div>
        </div>
          ...
          <div class="cols-sm-10">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="phoneNumber" id="phoneNumber"
                     ...
                     required value="${sessionScope.logged_user.phoneNumber}"/>
            </div>
          </div>
        </div>
          ...
          <div class="cols-sm-10">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="account" id="account"
                     pattern="^-?\\d+\\.?\\,?\\d*$"
                     required value="${sessionScope.logged_user.account}" disabled/>
            </div>
          </div>
        </div>
